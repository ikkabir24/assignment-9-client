...
const RegisterPage = () => {
    ...
    const handleRegister = (e) => {
        ...
        if (!hasUppercase || !hasLowercase || !isLongEnough) {
            toast.error("Password must be 6 digits long, must contain 1 uppercase and 1 lowercase characters");
            setError("Password must be 6 digits long, must contain 1 uppercase and 1 lowercase characters")
            return;
        }
